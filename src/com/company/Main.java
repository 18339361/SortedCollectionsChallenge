...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //we can add same thing more than once
        ...
        //making sure cars are in stock before we sell one
        if(sellItem(timsBasket, "car", 1) != 1){
            System.out.println("There are no more cars in stock");
        }

        sellItem(timsBasket, "spanner", 5); //does not exist
//        System.out.println(timsBasket);
...
//        System.out.println(stockList);
        ...
        //gives error because it returns an unmodifiable map i.e you can only read from it
//        temp = new StockItem("pen", 1.12);
//        stockList.Items().put(temp.getName(), temp);

        //individual items can be modified but map can't
        stockList.Items().get("car").adjustStock(2000);
        stockList.get("car").adjustStock(-1000);
        System.out.println(stockList);

        //neither individual items nor the map can be modified
